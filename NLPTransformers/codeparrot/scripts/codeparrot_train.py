...
import transformers
from transformers import pipeline, set_seed, AutoConfig, AutoModelForCausalLM, AutoTokenizer, get_scheduler, HfArgumentParser
import datasets
...
class ConstantLengthDataset(IterableDataset):
    ...
    def __init__(self, tokenizer, dataset, infinite=False, seq_length=1024,
                 num_of_sequences=1024, chars_per_token=3.8, tokenized=False):
