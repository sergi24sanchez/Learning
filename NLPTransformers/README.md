...
<img alt="book-cover" width=500 src="img/book_cover.jpg" id="book-cover"/>
...
- **Text Classification**: Fine-tuning BERT for sentiment analysis and NER
    ...
    <img alt="ner-confusion-matrix" width=500 src="img/ner_confusion_matrix.png" id="ner-confusion-matrix"/>
...
- **Cross-lingual Transfer**: Evaluating models in zero-shot settings
    ...
    <img alt="cross-lingual" width=500 src="img/cross-lingual_transfer.png" id="cross-lingual"/>
...
- **Summarization**: Training models and evaluating with BLEU and ROUGE
    ...
    <img alt="fine_tuning_pegasus" width=500 src="img/fine_tuning_pegasus.png" id="fine_tuning_pegasus"/>
...
- **Efficient Transformers**:  
  - Optimization methods: Quantization, Pruning, Distillation
    ...
    <img alt="transformers-efficiency" width=500 src="img/transformers_efficiency.png" id="transformers-efficiency"/>
...
- **Few-Shot & Zero-Shot Learning**:  
  ...
  - Data augmentation, embeddings, and domain adaptation
    ...
    <img alt="few-shot_learning" width=500 src="img/few-shot_learning.png" id="few-shot_learning"/>
...
<img alt="train-loss" width=500 src="img/train_loss.png" id="train-loss"/>
---
