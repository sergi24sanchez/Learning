...
class DataLoaderLite:
    def __init__(self, B, T, process_rank, num_processes, split): # if process_rank=0, num_processes=1 --> it is the same as 1 GPU
        self.B = B
        self.T = T
...
max_lr = 6e-4
min_lr = max_lr * 0.1
warmmup_steps = 715 # gpt3 paper says warmup lr over the first 375M tokens --> 375e6 / 2^19 = 715 steps
max_steps = 19073 # 10B tokens / 2^19 batch size = 19073 steps
